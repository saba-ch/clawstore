...
// ── Better Auth tables ──────────────────────────────────────
// These will be generated by @better-auth/cli in Phase 3.
// For now, define a minimal `users` table so FK references compile.
// The real auth tables (users, sessions, accounts, verifications)
// will replace this once Better Auth is wired up.
